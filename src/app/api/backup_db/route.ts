...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!secret) {
      console.error('[API BackupDB] JWT_SECRET no está configurado.');
      return NextResponse.json(
    ...
    console.log(`[API BackupDB] Response from management API:`, responseText);
    try {
    ...
    console.error('[API BackupDB] Error:', error.message);
