...
const MANAGEMENT_API_URL = 'http://168.181.187.83:3000/api/deploy';
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!secret) {
      console.error('[API Deploy] JWT_SECRET no está configurado.');
      return NextResponse.json(
    ...
    console.log(`[API Deploy] Response from management API:`, responseText);
    try {
